		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
						Generated by <a href="http://superseo.com/">super</a>'s <a href="http://superseo.com/wordpress/seo/">Super SEO plugin</a>, this is an XML Sitemap, meant for consumption by search engines.<br/>
				...
				<script type="text/javascript" src="http://cdn.superseo.com/js/jquery.tablesorter.min.js"></script>
