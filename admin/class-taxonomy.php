...
class WPSEO_Taxonomy {
	...
	function term_seo_form( $term ) {
		...
		echo '<h2>' . __( 'Super SEO Settings', 'seo-rotator-for-images' ) . '</h2>';
		echo '<table class="form-table">';

		$this->form_row( 'wpseo_title', __( 'SEO Title', 'seo-rotator-for-images' ), __( 'The SEO title is used on the archive page for this term.', 'seo-rotator-for-images' ), $tax_meta );
		$this->form_row( 'wpseo_desc', __( 'SEO Description', 'seo-rotator-for-images' ), __( 'The SEO description is used for the meta description on the archive page for this term.', 'seo-rotator-for-images' ), $tax_meta );
		if ( isset( $options['usemetakeywords'] ) && $options['usemetakeywords'] )
			$this->form_row( 'wpseo_metakey', __( 'Meta Keywords', 'seo-rotator-for-images' ), __( 'Meta keywords used on the archive page for this term.', 'seo-rotator-for-images' ), $tax_meta );
		$this->form_row( 'wpseo_canonical', __( 'Canonical', 'seo-rotator-for-images' ), __( 'The canonical link is shown on the archive page for this term.', 'seo-rotator-for-images' ), $tax_meta );
		$this->form_row( 'wpseo_bctitle', __( 'Breadcrumbs Title', 'seo-rotator-for-images' ), sprintf( __( 'The Breadcrumbs title is used in the breadcrumbs where this %s appears.', 'seo-rotator-for-images' ), $term->taxonomy ), $tax_meta );
		...
		$noindex_options = array(
			'default' => sprintf( __( 'Use %s default (Currently: %s)', 'seo-rotator-for-images' ), $term->taxonomy, $current ),
			'index'   => __( 'Always index', 'seo-rotator-for-images' ),
			'noindex' => __( 'Always noindex', 'seo-rotator-for-images' ) );
		$this->form_row( 'wpseo_noindex', sprintf( __( 'Noindex this %s', 'seo-rotator-for-images' ), $term->taxonomy ), sprintf( __( 'This %s follows the indexation rules set under Metas and Titles, you can override it here.', 'seo-rotator-for-images' ), $term->taxonomy ), $tax_meta, 'select', $noindex_options );

		$this->form_row( 'wpseo_sitemap_include', __( 'Include in sitemap?', 'seo-rotator-for-images' ), '', $tax_meta, 'select', array(
