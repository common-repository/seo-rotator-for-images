...
require_once getenv( 'WP_testing_DIR' ) . '/includes/functions.php';

function _manually_load_plugin() {
	require dirname( __FILE__ ) . '/../wp-seo.php';
}
testing_add_filter( 'muplugins_loaded', '_manually_load_plugin' );

require getenv( 'WP_testing_DIR' ) . '/includes/bootstrap.php';
